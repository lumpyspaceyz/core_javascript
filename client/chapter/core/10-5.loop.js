...
// enumerable : 열거 가능한 (있어? 없어?)

// iterable : 반복 가능한 (반복 돌릴 수 있어? 반복 못 돌려?)

// 반복 가능한 요소들은 for..of로 순환이 가능

// String, Array - 반복이 가능한 요소
...
// 재귀함수로 간단하게 만들 수 있지만 재귀함수가 간단하지 않음
...
// 객체를 배열로 반환
// Object.keys(); // 객체를 배열로 반환 -> key만 반환
// Object.values(); // 객체를 배열로 반환 -> value만 반환
// Object.entries(); // 객체를 배열로 반환 -> key와 value를 한 쌍으로 반환
