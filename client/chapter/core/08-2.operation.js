...
console.log('lessThen', lessThen); // lessThen true

let greaterThen = number[0] > number[1];
console.log('greaterThen', greaterThen); // greaterThen true

// ~ 보다 크거나 작음 또는 같음 → boolean
let lessThenAndEqual = number[4] <= number[1];
console.log('lessThenAndEqual', lessThenAndEqual); // lessThenAndEqual true

let greaterThenAndEqual = number[5] >= number[0];
console.log('greaterThenAndEqual', greaterThenAndEqual); // greaterThenAndEqual true
