...
const spreadObject = {...messenger}; // 제일 많이 씀!! 개꿀
...
// let combinedCssMap = Object.assign({}, cssMapA, cssMapB); // Object.assign() 사용
let combinedCssMap = {...cssMapA, ...cssMapB}; // spread syntax 사용
